...
class LibrosControllerTest < ActionController::TestCase
  ...
  test "should create libro" do
    assert_difference('Libro.count') do
      post :create, libro: { ISBN: @libro.ISBN, autor: @libro.autor, calificacion: @libro.calificacion, reseña: @libro.reseña, titulo: @libro.titulo }
    end
  ...
  test "should update libro" do
    patch :update, id: @libro, libro: { ISBN: @libro.ISBN, autor: @libro.autor, calificacion: @libro.calificacion, reseña: @libro.reseña, titulo: @libro.titulo }
    assert_redirected_to libro_path(assigns(:libro))
  end
